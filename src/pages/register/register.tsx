  ...
  return (
    <StyledRegister>
      <form onSubmit={handleSubmit(mySubmition)} className="Column">
        ...
        <p className="text-style-inputs-buttons-input-label">
        ...
        <div className="stick-label">
          ...
          <input
            ...
            className="text-style-inputs-buttons-input-placeholder"
            {...register("email")}
            placeholder="Ex: antônio@kenzie.com.br"
          />
        ...
        <div className="stick-label">
          ...
          <input
            ...
            className="text-style-inputs-buttons-input-placeholder"
            {...register("phone")}
            placeholder="Formato: (DDD) 90000-0000"
          />
        ...
        <div className="stick-label">
          ...
          <input
            ...
            placeholder="Ex: Especialista em venda de automóveis."
          />
        ...
        <div className="stick-label">
          <div className="flex-buttons">
            <input type="hidden" {...register("is_advertise")} />
            <button
              type="button"
